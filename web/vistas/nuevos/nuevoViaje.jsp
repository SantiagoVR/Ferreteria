...
<html>
    ...
    <body>
        <h1 class="text-center">Agregar Viaje</h1>
                            ...
                            <div class="grid-container">
                                <div class="grid-x grid-margin-x align-center-middle text-center">
                                    ...
                                    <div class="cell large-4 small-6">
                                        ...
                                        <input type="datetime-local" name="fechaEntrega" value="2018-06-01T08:30">
                                    </div>
                                    <div class="cell large-4 small-6">
                                        <i class="far fa-list-alt fa-3x"></i>
                                        <input type="text" name="materiales" placeholder="Materiales que se entregaran">
                                    </div>
                                    <div class="cell large-4 small-6">
                                        <i class="font fas fa-pencil-alt fa-3x"></i>
                                        <input type="text" name="descripcion" placeholder="Descripción de la etrega">
                                    </div>
                                    <div class="cell large-4 small-6">
                                        <i class="font fas fa-hand-holding-usd fa-3x"></i>
                                        <input type="number" name="dinero" placeholder="Precio">
                                    </div>
                                    <div class="cell large-4 small-6">
                                    ...
                                    <div class="cell large-4 small-6">
                                        <input class="button expanded success" type="submit" name="accion" value="Agregar Viaje">
                                    </div>
                                </div>
                            </div>
                        </form>
